...
import com.emma.sushi.adapter.CartAdapter
import com.emma.sushi.model.CartItems
    ...
    fun createNotification() {
        ...
        notificationBuilder.setStyle(
            NotificationCompat.BigTextStyle()
                .bigText("Ordered from ${restaurantName} and amounting to ${totalCost} €.Thank you for ordering from FoodRunner. Stay Safe!")
        )
