...
import com.emma.sushi.fragment.*
...
class DashboardActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        txtCurrentUser.text = sharedPreferences.getString("name", "Super Emma")
        txtMobileNumber.text = "+33-" + sharedPreferences.getString("mobile_number", "6 00 00 00 01")
        ...
        navigationView.setNavigationItemSelectedListener {
            ...
            when (it.itemId) {
                ...
                R.id.logout -> {
                    ...
                    alterDialog.setMessage("Voulez vous logout ?")
                    alterDialog.setPositiveButton("Oui")
                    { _, _ ->
